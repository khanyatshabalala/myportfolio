...
const LightboxModule = (() => {
    ...
    const lightboxData = {
        ...
        isc2: [
            'images/ISC2.jfif',
            'images/ISC2-colleagues.jfif',
            'images/ISC2-colleague.jfif',
            'images/ISC2-Context-matters.jfif'
        ],
        other: [
            'images/NextGenTalent.jpg',
            'images/ISC2.jfif',
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setupFooter();
    setupOtherEventsModal();
    setupChatWidget();
});

// Other Events modal
function setupOtherEventsModal() {
    const openBtn = document.getElementById('other-open');
    const modal = document.getElementById('other-modal');
    const closeBtn = document.getElementById('other-close');
...
function setupChatWidget() {
    ...
    // Simple bot responses (knowledge base)
    const botResponses = {
        'skills': 'I\'m skilled in JavaScript, React, HTML, CSS, Dialogflow chatbots, AWS, and more. Ask me about specific skills!',
        'projects': 'I\'ve built NovaWeb Designs, Golden Arrow Refill App, CV Generator, and an AI Content Generator. Check them out!',
        'events': 'I\'m active in AWS User Group CPT, CPTMSDUG, .NET Community, and SUI events. Love learning from the community!',
        'contact': 'You can reach me via email at mgebisak@gmail.com or connect on LinkedIn & GitHub!',
        'about': 'I\'m a junior developer at CAPACITI, passionate about building scalable, user-centric solutions.',
        'hi': 'Hey! 👋 How can I help you today?',
        'hello': 'Hi there! What would you like to know?',
        'help': 'Ask me about my skills, projects, events, or how to contact me!',
    };
    ...
    const sendMessage = () => {
        ...
        // Bot response (after a short delay for realism)
        setTimeout(() => {
            const lowerText = text.toLowerCase();
            let response = 'I\'m not sure about that. Try asking about skills, projects, events, or contact!';
